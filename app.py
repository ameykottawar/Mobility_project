...
engine = create_engine("mysql+pymysql://root:rAFSIyKKjVPHigulalHGkwvfyDzgExIE@switchback.proxy.rlwy.net:46784/railway")
...
columns_to_remove = {
    ...
    "shopify": [
        ...
        'Lineitem requires shipping', 'Lineitem taxable', 'Lineitem fulfillment status', 'Billing Name','Billing Zip', 'Billing Province', 
